...
NCountry = {
	...
	NUCLEAR_BOMB_DROP_WAR_SUPPORT_EFFECT_MAX_INFRA = 0.4, -- Reduce enemy national war support on nuking a province, the value scales with infrastructure up to this number
...
NSupply = {
	...
	SUPPLY_FROM_DAMAGED_INFRA = 0.075,                -- damaged infrastructure counts as this in supply calcs
